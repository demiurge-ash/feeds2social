 ...
 */
class RDF extends FeedParser implements IFeed
{
	...
	/**
	 *	Fetch items from feed as array of RDFElement objects.
	 *	
	 ...
	 *
	 *	@return 
	 *	    Array of RDFElement class instances
	 */
	public function getItems()
	{
		...
		foreach($entries as $entry)
		{
			...
			$items[] = new RDFElement($doc, $this->feedType);
		}
 ...
 * @author  Alex Dzyoba <finger@reduct.ru>
 */
class RDFElement implements IItem
{
	/** 
