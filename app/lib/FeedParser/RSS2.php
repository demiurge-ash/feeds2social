 ...
 */
class RSS2 extends FeedParser implements IFeed
{
	...
	public function getLink()
	{
		...
		if($items->length > 1)
            throw new \Exception('Strange feed link');
	...
	/**
	 *	Fetch items from feed as array of RSS2Element objects.
	 *	
	 ...
	 *
	 *	@return 
	 *	    Array of RSS2Element class instances
	 */
	public function getItems()
	{
		...
		foreach($entries as $entry)
		{
			...
			// to RSS2Element constructor (otherwise there will be
 ...
 * @author  Alex Dzyoba <finger@reduct.ru>
 */
class RSS2Element implements IItem
{
	/** 
