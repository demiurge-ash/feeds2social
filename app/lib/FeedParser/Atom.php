 ...
 */
class Atom extends FeedParser implements IFeed
{
	...
	/**
	 *	Fetch items from feed as array of AtomElement objects.
	 *	
	 ...
	 *
	 *	@return 
	 *	    Array of AtomElement class instances
	 */
	public function getItems()
	{
		...
		foreach($entries as $entry)
		{
			...
			// to AtomElement constructor (otherwise there will be
 ...
 * @author  Alex Dzyoba <finger@reduct.ru>
 */
class AtomElement implements IItem
{
	/** 
